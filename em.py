...
def get_em_mv_ali(X, clf, alpha_min=0.9, alpha_max=0.999, 
                       n_generated=100000, t_max = 0.9):
    ...
    s_X_clf = clf.decision_function(X) * -1
    s_unif_clf = clf.decision_function(unif) * -1
...
def get_em_mv_experiments(X, clf, s_X_clf, alpha_min=0.9, alpha_max=0.999, 
                       n_generated=100000, t_max = 0.9):
